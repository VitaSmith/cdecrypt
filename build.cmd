...
set CL=/nologo /errorReport:none /Ox /Gm- /GF /GS- /MP /MT /W4 /wd4200 /wd4204 /wd4214 /wd4324 /wd4996 /D_UNICODE /D_CRT_SECURE_NO_DEPRECATE /UNDEBUG /I"%OPENSSL_PATH%\include" /link /LIBPATH:"%OPENSSL_PATH%\lib"
...
cl.exe %APP_NAME%.cpp /Fe%APP_NAME%.exe
